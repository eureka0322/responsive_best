    ...
    render() {
        return (
            <div className="card card-block" id="create-ride">
                <h3 className="card-title text-uppercase">Delivery Details</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-6">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="quantity" id="quantity" placeholder="Quantity" required />
                            </div>
                        </div>
