...
class UserApiController extends Controller
{
    ...
    public function send_request(Request $request) {
        ...
        $this->validate($request, [
                ...
                'image' => 'required|mimes:ico,png,jpeg,jpg',
                'comments' => 'required',
                'use_wallet' => 'numeric',
                'use_wallet' => 'numeric',
                'use_wallet' => 'numeric',
        ...
        try{
            ...
            $UserRequest->quantity = $request->quantity;
            $UserRequest->comments = $request->comments;
            $UserRequest->image = Helper::upload_picture($request->image);
    ...
    public function estimated_fare(Request $request){
        ...
        // try{
            ...
            $price = $service_type->fixed * $request->quantity * $request->weight;
