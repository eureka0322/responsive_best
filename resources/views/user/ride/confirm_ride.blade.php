            ...
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
                    <dl class="dl-horizontal left-right">
                        ...
                        <dd>{{$service->name}}</dd>
                        <dt>@lang('user.quantity')</dt>
                        <dd>{{Request::get('quantity')}}</dd>
                        <dt>@lang('user.weight')</dt>
                        <dd>{{Request::get('weight')}} Kg(s)</dd>
                    ...
                    <p>@lang('user.image')</p>
                    <input type="file" name="image" class="upload" accept="image/x-png, image/jpeg"/>
                    <br>

                    <p>@lang('user.comments')</p>
                    <textarea name="comments" class="form-control" placeholder="@lang('user.comments')"></textarea>
                    <br>
