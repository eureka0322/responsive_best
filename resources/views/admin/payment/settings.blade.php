            ...
            <form action="{{route('admin.settings.payment.store')}}" method="POST">
                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-4">
                                <label for="paypal-payments" class="col-form-label">
                                    Paypal Payments
                                </label>
                            </div>
                            <div class="col-xs-6">
                                <input @if(Setting::get('PAYPAL') == 1) checked  @endif name="PAYPAL" id="paypal-payments" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div>
