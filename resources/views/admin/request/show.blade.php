            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $request->quantity ? $request->quantity : '-' }}</dd>

                        <dt class="col-sm-4">Weight in Kg(s) :</dt>
                        <dd class="col-sm-8">{{ $request->weight ? $request->weight : '-' }}</dd>
                        ...
                        <dd class="col-sm-8">
                            @if($request->image)
                                <a target="_blank" href="{{$request->image}}">View Image</a>
                            @else
                                {{'-'}}
                            @endif
                        </dd>
